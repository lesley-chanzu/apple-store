  ...
  return (
    <div className='2xl:w-80 xl:w-52 w-44 h-full bg-[#f8f8f8] flex flex-col justify-between pt-5 pl-6 pb-14 md:pb-0'>
      ...
      <div className='flex flex-col flex-grow'>
        {navItems.map((item, index) => (
          ...
          >
            ...
            <span className="text-sm text-gray-500 mr-auto mx-2.2 tracking-wider">{item.label}</span>
      ...
      <div className='flex justify-between pr-6 pb-2 '>
        <a href='#'>
          <i className="bx bxl-instagram text-2xl text-pink-400"></i>
        </a>
        <a href='#'>
          <i className="bx bxl-twitter text-2xl text-pink-400"></i>
        </a>
        <a href='#'>
          <i className="bx bxl-facebook text-2xl text-pink-400"></i>
        </a>
        <a href='#'>
          <i className="bx bxl-youtube text-2xl text-pink-400"></i>
        </a>
      </div>
    </div>
  )
