...
const Watch = () => {
    return (
        <div className='flex flex-col items-center justify-around bg-white h-full py-8 px-4'>
            <h1 className='2xl:text-4xl xl:text-3xl md:text-2xl font-semi-bold text-gray-700 mb-8'>Which Apple watch is right for you?
            </h1>
            <div className='w-full flex justify-around'>
                {watchModels.map((watch, index) => (
                    <div className='w-50 h-[430px] flex flex-col justify-around group'>
                        <div
                            key={index}
                        ...
                        <div>
                            ...
                            <a href='#' className='my-2 text-base text-blue-400'>From {watch.price}</a>
