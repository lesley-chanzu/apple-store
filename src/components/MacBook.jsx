...
const MacBook = () => {
    ...
    return (
        <div className='flex flex-col items-center justify-around bg-white p-8 h-full overflow-y-auto'>
            ...
            <div className='flex '>
                ...
                ${index === selectedChip ? "border-2 border-blue-400" : "border-gray-700"}`}
